...
After the container's package manager runs, open a new terminal session and you should be able to run bash commands from within the container. Any pnpm dist:linux builds should also now show up on your host filesystem.
